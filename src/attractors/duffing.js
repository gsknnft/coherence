 ...
 */
export function computeDuffing({ params = DEFAULT_DUFFING_PARAMS, initialPoint = { x: 1, y: 0, z: 0 }, steps = 50000, dt = 0.01, }) {
    ...
    for (let i = 0; i < steps; i++) {
        // Duffing equations
        const dx = y;
        const dy = -delta * y - alpha * x - beta * x ** 3 + gamma * Math.cos(omega * t);
